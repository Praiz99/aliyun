...
public class PopPubServer {
    ...
    public static boolean sendToTopic(String topic) throws UnsupportedEncodingException {
        ...
        String accessKey = "LTAI5tPmQRPrRTPjnocrmX7i";
        String accessSecret = "GcvAjrqghKSdaZiQGGPnr0N28ySb9E";
        final String productKey = "gr6xZpppJHj";
        //设置client的参数
        ...
        request.setQos(1);
        //设置发布消息的topic
        request.setTopicFullName("/gr6xZpppJHj/guangzhao/user/get");
